...
double IMUState::gyro_noise = 0.00020312;
double IMUState::acc_noise = 0.00299859;
double IMUState::gyro_bias_noise = 0.00000024;
double IMUState::acc_bias_noise = 0.00013725;
...
bool MsckfVio::loadParameters() {
  ...
  nh.param<double>("noise/gyro", IMUState::gyro_noise, 0.00020312);
  nh.param<double>("noise/acc", IMUState::acc_noise, 0.00299859);
  nh.param<double>("noise/gyro_bias", IMUState::gyro_bias_noise, 0.00000024);
  nh.param<double>("noise/acc_bias", IMUState::acc_bias_noise, 0.00013725);
